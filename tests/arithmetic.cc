...
TEST_CASE("Arithmetic") {
	...
	// Fraction
	REQUIRE(eval(numberConstant1 / numberConstant2) == (2.f / 3.f));
	REQUIRE(eval(numberConstant2 / numberConstant1) == (3.f / 2.f));
	REQUIRE(eval(numberConstant1 / 5.f) == (2.f / 5.f));
	REQUIRE(eval(numberConstant2 / 5.f) == (3.f / 5.f));
	REQUIRE(eval(5.f / numberConstant1) == (5.f / 2.f));
	REQUIRE(eval(5.f / numberConstant2) == (5.f / 3.f));
}