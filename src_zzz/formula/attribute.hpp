...
namespace Formula {
	...
	struct AttributeCount : FormulaBase<int32_t, Type::constant> {
		...
		void print(Descriptor &descriptor, const Context &context, Step) const {
			descriptor.add(std::format("{} count", Utils::Stringify(attribute)), eval(context));
		}
	...
	struct AttributeCountOthers : FormulaBase<int32_t, Type::constant> {
		...
		void print(Descriptor &descriptor, const Context &context, Step) const {
			descriptor.add(std::format("{} count others", Utils::Stringify(attribute)), eval(context));
		}
	...
	struct SameAttributeCount : FormulaBase<int32_t, Type::constant> {
		void print(Descriptor &descriptor, const Context &context, Step) const {
			descriptor.add("Team same attribute count", eval(context));
		}
	...
	struct OtherAttributeCount : FormulaBase<int32_t, Type::constant> {
		void print(Descriptor &descriptor, const Context &context, Step) const {
			descriptor.add("Team other attribute count", eval(context));
		}
	...
	struct IsAgentAttribute : FormulaBase<bool, Type::constant> {
		...
		void print(Descriptor &descriptor, const Context &context, Step) const {
			descriptor.add(std::format("Is agent {}", Utils::Stringify(attribute)), eval(context));
		}
	...
	struct IsAgentVortexableAttribute : FormulaBase<bool, Type::constant> {
		...
		void print(Descriptor &descriptor, const Context &context, Step) const {
			descriptor.add(std::format("Is agent {} vortexable", agentIndex), eval(context));
		}
	...
	struct IsTargetAgentAttribute : FormulaBase<bool, Type::constant> {
		...
		void print(Descriptor &descriptor, const Context &context, Step) const {
			descriptor.add(std::format("Is target agent {}", Utils::Stringify(attribute)), eval(context));
		}
