...
namespace Stats {
	...
	namespace Values {
		...
		inline const std::unordered_map<Stat, MainStatContainer> mainStat{
			...
			{Stat::def, {std::array{0.0400f, 0.0533f, 0.0667f, 0.0800f, 0.0933f, 0.1067f, 0.1200f, 0.1333f, 0.1467f, 0.1600f}, std::array{0.0800f, 0.1000f, 0.1200f, 0.1400f, 0.1600f, 0.1800f, 0.2000f, 0.2200f, 0.2400f, 0.2600f, 0.2800f, 0.3000f, 0.3200f}, std::array{0.1200f, 0.1440f, 0.1680f, 0.1920f, 0.2160f, 0.2400f, 0.2640f, 0.2880f, 0.3120f, 0.3360f, 0.3600f, 0.3840f, 0.4080f, 0.4320f, 0.4560f, 0.4800f}}},
		...
		inline const std::unordered_map<Stat, SubStatContainer> subStat{
			...
			{Stat::atk_, {1.f, 2.f, 3.f}},
			{Stat::cd, {1.6f, 3.2f, 4.8f}},
			{Stat::cr, {0.8f, 1.6f, 2.4f}},
			{Stat::def, {5.f, 10.f, 15.f}},
			{Stat::def_, {1.6f, 3.2f, 4.8f}},
			{Stat::hp, {39.f, 75.f, 112.f}},
			{Stat::hp_, {1.f, 2.f, 3.f}},
