...
namespace Store {
	...
	[[nodiscard]] inline auto serializeOptions(auto &&options) {
	...
	inline void deserializeOptions(const std::vector<Serialization::Save::OptionTypes> &options, auto &&targetMap) {
	...
	[[nodiscard]] static inline Serialization::Save::Save save() {
	...
	static inline void load(const Serialization::Save::Save &save) {
