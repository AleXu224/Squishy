...
namespace Stats {
	...
	namespace Values {
		inline const std::unordered_map<Stat, std::array<std::array<float, 21>, 5>> mainStat{
		...
		struct SubstatData {
			std::array<float, 2> star1;
			std::array<float, 3> star2;
			std::array<float, 4> star3;
			std::array<float, 4> star4;
			std::array<float, 4> star5;
		};

		inline const std::unordered_map<Stat, SubstatData> subStat{
			{Stat::hp, SubstatData{std::array{23.9000f, 29.8800f}, std::array{50.1900f, 60.9500f, 71.7000f}, std::array{100.3800f, 114.7200f, 129.0600f, 143.4000f}, std::array{167.3000f, 191.2000f, 215.1000f, 239.0000f}, std::array{209.1300f, 239.0000f, 268.8800f, 298.7500f}}},
			{Stat::hp_, SubstatData{std::array{0.0117f, 0.0146f}, std::array{0.0163f, 0.0198f, 0.0233f}, std::array{0.0245f, 0.0280f, 0.0315f, 0.0350f}, std::array{0.0326f, 0.0373f, 0.0420f, 0.0466f}, std::array{0.0408f, 0.0466f, 0.0525f, 0.0583f}}},
			{Stat::atk, SubstatData{std::array{1.5600f, 1.9500f}, std::array{3.2700f, 3.9700f, 4.6700f}, std::array{6.5400f, 7.4700f, 8.4000f, 9.3400f}, std::array{10.8900f, 12.4500f, 14.0000f, 15.5600f}, std::array{13.6200f, 15.5600f, 17.5100f, 19.4500f}}},
			{Stat::atk_, SubstatData{std::array{0.0117f, 0.0146f}, std::array{0.0163f, 0.0198f, 0.0233f}, std::array{0.0245f, 0.0280f, 0.0315f, 0.0350f}, std::array{0.0326f, 0.0373f, 0.0420f, 0.0466f}, std::array{0.0408f, 0.0466f, 0.0525f, 0.0583f}}},
			{Stat::def, SubstatData{std::array{1.8500f, 2.3100f}, std::array{3.8900f, 4.7200f, 5.5600f}, std::array{7.7800f, 8.8900f, 10.0000f, 11.1100f}, std::array{12.9600f, 14.8200f, 16.6700f, 18.5200f}, std::array{16.2000f, 18.5200f, 20.8300f, 23.1500f}}},
			{Stat::def_, SubstatData{std::array{0.0146f, 0.0182f}, std::array{0.0204f, 0.0248f, 0.0291f}, std::array{0.0306f, 0.0350f, 0.0393f, 0.0437f}, std::array{0.0408f, 0.0466f, 0.0525f, 0.0583f}, std::array{0.0510f, 0.0583f, 0.0656f, 0.0729f}}},
			{Stat::er, SubstatData{std::array{0.0130f, 0.0162f}, std::array{0.0181f, 0.0220f, 0.0259f}, std::array{0.0272f, 0.0311f, 0.0350f, 0.0389f}, std::array{0.0363f, 0.0414f, 0.0466f, 0.0518f}, std::array{0.0453f, 0.0518f, 0.0583f, 0.0648f}}},
			{Stat::em, SubstatData{std::array{4.6600f, 5.8300f}, std::array{6.5300f, 7.9300f, 9.3300f}, std::array{9.7900f, 11.1900f, 12.5900f, 13.9900f}, std::array{13.0600f, 14.9200f, 16.7900f, 18.6500f}, std::array{16.3200f, 18.6500f, 20.9800f, 23.3100f}}},
			{Stat::cr, SubstatData{std::array{0.0078f, 0.0097f}, std::array{0.0109f, 0.0132f, 0.0155f}, std::array{0.0163f, 0.0186f, 0.0210f, 0.0233f}, std::array{0.0218f, 0.0249f, 0.0280f, 0.0311f}, std::array{0.0272f, 0.0311f, 0.0350f, 0.0389f}}},
			{Stat::cd, SubstatData{std::array{0.0155f, 0.0194f}, std::array{0.0218f, 0.0264f, 0.0311f}, std::array{0.0326f, 0.0373f, 0.0420f, 0.0466f}, std::array{0.0435f, 0.0497f, 0.0560f, 0.0622f}, std::array{0.0544f, 0.0622f, 0.0699f, 0.0777f}}},
		};

		inline const std::unordered_map<Stat, std::array<float, 5>> averageSubStat{
			{Stat::hp, std::array{26.8900f, 60.9467f, 121.8900f, 203.1500f, 253.9400f}},
			{Stat::hp_, std::array{0.0132f, 0.0198f, 0.0298f, 0.0396f, 0.0495f}},
			{Stat::atk, std::array{1.7550f, 3.9700f, 7.9375f, 13.2250f, 16.5350f}},
			{Stat::atk_, std::array{0.0132f, 0.0198f, 0.0298f, 0.0396f, 0.0495f}},
			{Stat::def, std::array{2.0800f, 4.7233f, 9.4450f, 15.7425f, 19.6750f}},
			{Stat::def_, std::array{0.0164f, 0.0248f, 0.0372f, 0.0495f, 0.0620f}},
			{Stat::er, std::array{0.0146f, 0.0220f, 0.0330f, 0.0440f, 0.0550f}},
			{Stat::em, std::array{5.2450f, 7.9300f, 11.8900f, 15.8550f, 19.8150f}},
			{Stat::cr, std::array{0.0088f, 0.0132f, 0.0198f, 0.0265f, 0.0330f}},
			{Stat::cd, std::array{0.0175f, 0.0264f, 0.0396f, 0.0529f, 0.0660f}},
		};
	}// namespace Values
}// namespace Stats
