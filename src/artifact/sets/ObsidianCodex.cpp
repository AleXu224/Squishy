...
const Artifact::Set Artifact::Sets::obsidianCodex{
	...
	.name = "Obsidian Codex",
	.setup = []() -> Set::Setup {
		auto twoPcDMG = Requires{.requirement = IsActive("obsidianCodexNightsoul"), .ret = Constant{.value = 0.15f}};
		auto fourPcCr = Requires{.requirement = IsActive("obsidianCodexConsumed"), .ret = Constant{.value = 0.4f}};
