...
std::array<std::pair<const std::vector<Option::Types> Option::CharacterList::*, Formula::BoolNode>, 11> Option::CharacterList::getMembersAndConditions() {
	return std::array<std::pair<const std::vector<Option::Types> Option::CharacterList::*, Formula::BoolNode>, 11>{
